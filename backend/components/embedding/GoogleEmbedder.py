...
from backend.components.interfaces import Embedder
from backend.components.document import Document


class GoogleEmbedder(Embedder):
    """
    GoogleEmbedder for rag
.
    """
    ...
    def embed(
        ...
        """Embed rag
     documents and its chunks to Weaviate
        @parameter: documents : list[Document] - List of rag
     documents
